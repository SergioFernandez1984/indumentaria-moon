   ...
   const pagoHTML = 
     ...
     ` 
       ...
       <div style="background: #eff6ff; border: 1px solid #93c5fd; border-radius: 8px; padding: 16px; margin: 16px 0;"> 
         <p style="margin: 0; color: #1e40af;">💳 Te enviaremos el link de pago de Mercado Pago a la brevedad.</p> 
       </div> 
     `; 
   ...
   await resend.emails.send({ 
     ...
     html: ` 
       <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; color: #111;"> 
         <div style="background: #111; padding: 24px; text-align: center; border-radius: 12px 12px 0 0;"> 
         ...
         <div style="padding: 24px; border: 1px solid #eee; border-top: none; border-radius: 0 0 12px 12px;"> 
           ...
           <p style="color: #666; font-size: 13px; margin-top: 24px;"> 
             ¿Tenés alguna duda? Escribinos a <a href="mailto:indumentariamoon@gmail.com">indumentariamoon@gmail.com</a> 
           </p> 
         </div> 
       </div> 
     `, 
